...
public class UserServiceTest {
    ...
    @Test
    public void testWhetherUserIsRestaurateurToReturnTrue(){
        boolean isRestaurateur=this.userService.isRestaurateur("ivana@abv.bg");
    ...
    @Test
    public void testIsUserReturnTrue(){
        boolean isUser=this.userService.isUser("peter@abv.bg");
